    ...
    <div class="top-row">
      <div :class="[saleBorderClass, 'top', 'part']">
        ...
        <div class="robot-name"> {{ selectedRobot.head.title }}
          <span class="sale" v-if="selectedRobot.head.onSale==true"> On Sale!! </span>
        </div>
...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    ...
    if (this.addedToCart) {
      ...
      const response = confirm('sure you wanna go? stuff in cart');
      next(response);
    }
  },
  data() {
  ...
  methods: {
    addToCart() {
      ...
      const cost = robot.torso.cost + robot.rightArm.cost + robot.leftArm.cost + robot.torso.cost + robot.base.cost;
